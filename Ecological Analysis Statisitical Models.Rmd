...
Combo.df$Subsistence <- relevel(Combo.df$Subsistence, ref = "Horticulture")
...
Combo.df$Biome <- relevel(Combo.df$Biome, ref = "Grasslands")
...
ggplot() +
  ...
  geom_point(data = Combo.df, 
             aes(x = long, y = lat, color = Presence),
             size = 2, alpha = 0.8) +
  scale_color_manual(values = c("Presence of Menstrual Taboos" = "darkred", "Absence of Menstrual Taboos" = "darkblue")) +
  theme_minimal() +
  labs(title = "Global Presence of Menstrual Taboos",
       color = "Menstrual Taboo") +
  coord_sf()
...
ggplot() +
  geom_sf(data = world, fill = "gray95", color = "gray50") +
  geom_point(data = Combo.df, 
             aes(x = long, y = lat, color = Restriction),
             size = 2, alpha = 0.8) +
  scale_color_manual(values = c("Absence" = "darkblue", "Minimally Restrictive" = "darkgreen", "Moderately Restrictive" = "darkorange", "Severely Restrictive" = "darkred")) +
  theme_minimal() +
  labs(title = "Global Restriction Levels of Menstrual Taboos",
       color = "Menstrual Taboo") +
  coord_sf()
```
...
```{r P3 summary table}
#Creating the summary table for the model
summary(Presence.Biome, prob = 0.90)
```
