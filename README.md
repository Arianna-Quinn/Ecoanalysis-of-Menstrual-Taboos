...
1. Time-calibrated SCCS supertree ultrametric: The phylogenetic tree created by Duba & Zvarvy (2016) in a nexus file.

2. Master's data set: This is the cleaned and compiled dataset in a CSV file.

3. R Code: This is the RMD files of the R code to complete the ecological analysis in this thesis. They include (In order to effectively run all the code you must run the files from top to bottom):
